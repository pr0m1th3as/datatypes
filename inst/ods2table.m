...
function [tbl, rowTimesName] = ods2table (filename, varargin)
  ...
  if (! (ischar (filename) || iscellstr (filename) || isa (filename, 'string')))
    error (strcat ("ods2table: FILENAME must be a character vector,", ...
                   " cellstr, or string."));
  endif
  ...
  hdr = sscanf (meta{1,1}, ...
        strcat ("# varTypes %d rows; varNames %d rows;", ...
...
%!demo
%! ## `ods2table` reads an OpenDocument spreadsheet into a table.  With no
%! ## options it reads the first data sheet.
%!
...
%!        '<text:p>11</text:p></table:table-cell>' ...
%!        '</table:table-row></table:table>' ...
%!        '<table:table table:name="Two"><table:table-row>' ...
%!        '<table:table-cell office:value-type="float" office:value="22">' ...
%!        '<text:p>22</text:p></table:table-cell>' ...
%!        '</table:table-row></table:table>' ...
