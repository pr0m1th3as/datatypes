...
## not mistaken for the method, then reported as not yet supported.
...
%!error <groupfilter: binning grouping variable '1' by time unit 'month' is not yet supported; use bin edges or a number of bins.> ...
