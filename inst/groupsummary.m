...
%!error <groupsummary: binning grouping variable '1' by time unit 'month' is only supported for datetime variables.> ...
...
%!error <groupsummary: grouping variables must be vectors.> ...
%! groupsummary ([1; 2], repmat ('a', [2, 2, 2]), 'mean')
%!error <groupsummary: grouping variables must be vectors.> ...
%! groupsummary ([1; 2], ones (2, 2, 2), 'mean')
%!error <groupsummary: column 1 of A: named method 'mean' is not supported for data of type 'cell'; use a function handle.> ...
%! groupsummary ({'a'; 'b'}, [1; 2], 'mean')
