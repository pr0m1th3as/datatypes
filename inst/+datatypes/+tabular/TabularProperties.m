  ...
  methods (Access = private)
    ...
    function txt = customPropertyText (this)
      if (isempty (this.CustomProperties))
        ## The newline leads the second chunk rather than trailing the
        ## first, 'strcat' stripping whitespace off the end of every one.
        txt = strcat ("        CustomProperties: No custom properties are", ...
                      " set.\n      Use 'addprop' and 'rmprop' methods to", ...
                      " modify CustomProperties.");
        return;
      endif
