...
################################################################################
  ...
  methods (Access = public)
    ...
    ## (@var{calD})} on a 2-by-2-by-2 array returns 2 and 4; asking for more
    ...
    function varargout = size (this, varargin)
      if (! isempty (varargin))
        ...
        if (nargout > 1 && numel (sz) != nargout)
          error (strcat ("calendarDuration.size: nargout does not match the",
        ...
        ## dimensions into the last output, as MATLAB does.
        if (nargout > numel (sz))
...
%!test
%! ## The suite for this class is inst/tests/calendarDuration.m-tst.
